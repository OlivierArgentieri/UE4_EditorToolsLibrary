...
TSharedPtr< FSlateStyleSet > FtestWindowStyle::StyleInstance = NULL;
...
TSharedRef< FSlateStyleSet > FtestWindowStyle::Create()
{
	...
	Style->SetContentRoot(IPluginManager::Get().FindPlugin("testWindow")->GetBaseDir() / TEXT("Resources"));

	Style->Set("testWindow.OpenPluginWindow", new IMAGE_BRUSH(TEXT("ButtonIcon_40x"), Icon40x40));
